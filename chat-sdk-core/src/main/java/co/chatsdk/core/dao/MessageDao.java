...
public class MessageDao extends AbstractDao<Message, Long> {
    ...
    public static class Properties {
        ...
        public final static Property AllRead = new Property(13, boolean.class, "allRead", false, "ALL_READ");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"MESSAGE\" (" + //
                ...
                "\"ALL_READ\" INTEGER NOT NULL );"); // 13: allRead
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, Message entity) {
        ...
        stmt.bindLong(14, entity.getAllRead() ? 1L: 0L);
    }
    ...
    public Message readEntity(Cursor cursor, int offset) {
        Message entity = new Message( //
            ...
            cursor.getShort(offset + 13) != 0 // allRead
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Message entity, int offset) {
        ...
        entity.setAllRead(cursor.getShort(offset + 13) != 0);
     }
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(',');
            SqlUtils.appendColumns(builder, "T3", daoSession.getThreadDao().getAllColumns());
            builder.append(" FROM MESSAGE T");
            builder.append(" LEFT JOIN MESSAGE T0 ON T.\"NEXT_MESSAGE_ID\"=T0.\"_id\"");
            builder.append(" LEFT JOIN MESSAGE T1 ON T.\"LAST_MESSAGE_ID\"=T1.\"_id\"");
            builder.append(" LEFT JOIN USER T2 ON T.\"SENDER_ID\"=T2.\"_id\"");
            builder.append(" LEFT JOIN THREAD T3 ON T.\"THREAD_ID\"=T3.\"_id\"");
            builder.append(' ');
