 ...
 */
public class ChatSDKNearbyUsersListAdapter extends ChatSDKAbstractUsersListAdapter<ChatSDKAbstractUsersListAdapter.AbstractUserListItem> {

    private static final String TAG = ChatSDKNearbyUsersListAdapter.class.getSimpleName();
    private static final boolean DEBUG = Debug.UsersWithStatusListAdapter;

    public ChatSDKNearbyUsersListAdapter(Activity activity) {
        super(activity);
        init();
    }

    public ChatSDKNearbyUsersListAdapter(Activity activity, boolean isMultiSelect) {
        super(activity, isMultiSelect);
        init();
    }

    public ChatSDKNearbyUsersListAdapter(Activity activity, List<AbstractUserListItem> listData) {
        super(activity, listData);
        init();
    }

    public ChatSDKNearbyUsersListAdapter(Activity activity, List<AbstractUserListItem> listData, boolean multiSelect) {
