...
public class BMessageReceipt {
    ...
    private Long BMessage__resolvedKey;
    ...
    public BMessage getBMessage() {
        Long __key = this.BMessageId;
        if (BMessage__resolvedKey == null || !BMessage__resolvedKey.equals(__key)) {
            if (daoSession == null) {
                throw new DaoException("Entity is detached from DAO context");
            }
            BMessageDao targetDao = daoSession.getBMessageDao();
            BMessage BMessageNew = targetDao.load(__key);
            synchronized (this) {
                BMessage = BMessageNew;
            	BMessage__resolvedKey = __key;
            }
        }
        return BMessage;
    }
    ...
    public void setBMessage(BMessage BMessage) {
        synchronized (this) {
            ...
            BMessageId = BMessage == null ? null : BMessage.getId();
            BMessage__resolvedKey = BMessageId;
        }
    }
